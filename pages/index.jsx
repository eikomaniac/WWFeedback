            ...
            <div>
              ...
              <Center>
                <ButtonGroup spacing="10">
                  ...
                  <Button size="lg" leftIcon={<IoCreateOutline />} onClick={() => setPageView('attendee')}>Attendee</Button>
                  <Button size="lg" leftIcon={<IoCreateOutline />} onClick={() => setPageView('host')}>Host</Button>
                </ButtonGroup>
              </Center>
            </div>
          )}
